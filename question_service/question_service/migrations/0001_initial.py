# Generated by Django 5.2.3 on 2025-10-09 14:31
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='QuestionScore',
            fields=[
                ('question', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='score', serialize=False, to='question_service.question')),
        ...
        migrations.CreateModel(
            name='QuestionStats',
            fields=[
                ('question', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='stats', serialize=False, to='question_service.question')),
        ...
        migrations.AddIndex(
            model_name='question',
            index=django.contrib.postgres.indexes.GinIndex(fields=['search_tsv'], name='questions_search__d76f16_gin'),
        ),
        migrations.AddField(
            model_name='questionsolution',
            name='question',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='solutions', to='question_service.question'),
        ),
